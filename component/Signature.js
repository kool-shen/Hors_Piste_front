import {
  ...
  const Sign = (props) => {
    ...
    const handleData = async (data) => {
      ...
      const encoding = await FileSystem.writeAsStringAsync(path, data.replace("data:image/png;base64,", ""), { encoding: FileSystem.EncodingType.Base64 })
      ...
      formData.append('location', location)
       fetch(`http://10.2.0.228:3000/signature/`, {
          method: 'POST',
          body: formData,
